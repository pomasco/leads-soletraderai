/*
  ...
  1. New Fields
    - Added fields to match agents.json configuration
    - Added support for rich content and metadata
    - Added performance optimization indexes

  2. Data Types
    - Used text[] for array fields (categories, tags, etc.)
    - Used jsonb for complex nested structures
